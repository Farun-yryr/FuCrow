...
// 必勝手探索で見るノード数の上限
// rejust only the number of hands is over 6 cards
#define MAX_SEARCH_NODE 800000
// シミュレーション回数
#define SIMULATION_COUNT 3700 
// temporal difference learningにおける減衰関数
#define TD_PARAMETER 0.7
#define TD_PARAMETER_BETA 0.7
...
typedef struct{
	...
	int point[5];// point[i]: プレイヤーiの総得点
} fieldInfo;
